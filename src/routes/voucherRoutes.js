...
router.put("seller/:voucherId", authenticate, authorizeSeller, updateVoucher); // Update voucher
router.delete("seller/:voucherId", authenticate, authorizeSeller, deleteVoucher); // Delete voucher
